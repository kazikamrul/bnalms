...
@Component({
  selector: 'app-memberinfo-list',
  templateUrl: './memberinfo-list.component.html',
  styleUrls: ['./memberinfo-list.component.sass']
})
export class MemberInfoListComponent implements OnInit {
