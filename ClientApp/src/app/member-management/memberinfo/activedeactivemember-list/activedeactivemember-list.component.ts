...
@Component({
  selector: 'app-activedeactivemember-list',
  templateUrl: './activedeactivemember-list.component.html',
  styleUrls: ['./activedeactivemember-list.component.sass']
})
export class ActiveDeactiveMemberListComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private MemberInfoService:MemberInfoService,private router: Router,private confirmService: ConfirmService) { }
