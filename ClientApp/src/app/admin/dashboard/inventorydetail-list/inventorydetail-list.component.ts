...
@Component({
  selector: 'app-inventorydetail-list',
  templateUrl: './inventorydetail-list.component.html',
  styleUrls: ['./inventorydetail-list.component.sass']
})
export class InventoryDetailListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.role == this.userRole.SuperAdmin){
      ...
      this.getAllMemberInfoListSpRequest(this.branchId);
    }
  }
  backClicked() {
    this._location.back();
  ...
  getAllMemberInfoListSpRequest(baseSchoolNameId){
    
      this.DashboardService.getInventoryDetailListForDashboard(baseSchoolNameId).subscribe((response) => {
