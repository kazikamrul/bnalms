...
@Component({
  selector: 'app-view-softcopymaterial',
  templateUrl: './view-softcopymaterial.component.html',
  styleUrls: ['./view-softcopymaterial.component.sass']
})

export class ViewSoftcopyMaterialComponent implements OnInit {
