...
@Component({
  selector: 'app-bookinformationmember-list',
  templateUrl: './bookinformationmember-list.component.html',
  styleUrls: ['./bookinformationmember-list.component.sass']
})
export class BookInformationMemberListComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private BookIssueAndSubmissionService: BookIssueAndSubmissionService,private _location: Location,private http: HttpClient,private authService: AuthService,private fb: FormBuilder,private AuthorInformationService:AuthorInformationService,private DashboardService:DashboardService,private BookInformationService:BookInformationService,private router: Router,private confirmService: ConfirmService,private route: ActivatedRoute) { }
  ...
  getBookInformationList(){
        this.BookInformationService.getBookInfoListForMemberByBaseSchoolNameId(this.pno,0 ,'', 0 ,this.bookTitleInfoId).subscribe(response => {
          ...
          body{  width: 99%;}
            ...
            table, td, th {
                  ...
                  font-size: 13px;
                    ...
                    .table.table.tbl-by-group.db-li-s-in tr .cl-mrk-rmrk-act-m{
                      display: none;
                    }
  ...
  getIssueRequestPopup(bookInformationId){
    this.popupIssueRequest = true;
    this.infoPopUpTitle = "Online Request List";
    this.BookIssueAndSubmissionService.getOnlineBookRequestListByBookInfo(bookInformationId).subscribe(res => {
      console.log("res");
  ...
  onLibrarySelectionChange(value){
      console.log(value)
  }
  onBookCategorySelectionChange(value){
    console.log(value)
  }
  ...
  applyFilter(searchText: any, deptId,bookCatId){ 
   ...
   // this.onLibrarySelectionChange(this.deptId)
  //  if(this.deptId !=null || this.bookCatId != null){
  //   this.getBookInformationList(this.searchText,this.deptId,this.bookCatId);
  //  }
  } 
  reloadCurrentRoute() {
