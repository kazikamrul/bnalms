...
export class ChildParameterService {
  ...
  SetupTraineeId(bookInformationId: number) {

    localStorage.setItem('currentTraineeId', JSON.stringify(bookInformationId));
    this.currentTraineeIdSubject.next(bookInformationId);
  }
}
