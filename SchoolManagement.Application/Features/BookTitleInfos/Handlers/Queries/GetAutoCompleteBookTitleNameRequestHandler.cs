...
{
    public class GetAutoCompleteBookTitleNameRequestHandler : IRequestHandler<GetAutoCompleteBookTitleNameRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<BookTitleInfo> _BookTitleInfoRepository; 
        public GetAutoCompleteBookTitleNameRequestHandler(ISchoolManagementRepository<BookTitleInfo> BookTitleInfoRepository)
        {
            _BookTitleInfoRepository = BookTitleInfoRepository;
        }
          
        public async Task<List<SelectedModel>> Handle(GetAutoCompleteBookTitleNameRequest request, CancellationToken cancellationToken)
        {
