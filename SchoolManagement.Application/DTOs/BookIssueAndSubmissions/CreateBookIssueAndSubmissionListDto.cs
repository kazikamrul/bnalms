using SchoolManagement.Application.DTOs.BookIssueAndSubmission.Converter;
using System;
...
{
    public class CreateBookIssueAndSubmissionListDto
    {
        ...
        public List<IssueListFormDto>? IssueListForm { get; set; }
    }
}
