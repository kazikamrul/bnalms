...
namespace SchoolManagement.Application.Profiles
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
         ...
         //   #region ClassRoutine Bulk Entry Mappings
         //   CreateMap<ClassRoutineListDto, ClassRoutine>().ReverseMap()
         //  .ForMember(d => d.ClassRoutineId, opt => opt.MapFrom(s => s.ClassRoutineId))
         //  .ForMember(d => d.CourseModuleId, opt => opt.MapFrom(s => s.CourseModuleId))
         ////  .ForMember(d => d.ClassPeriodId, opt => opt.MapFrom(s => s.ClassPeriodId))
         //  .ForMember(d => d.BaseSchoolNameId, opt => opt.MapFrom(s => s.BaseSchoolNameId))
         //  .ForMember(d => d.ClassCountPeriod, opt => opt.MapFrom(s => s.ClassCountPeriod))
         //  .ForMember(d => d.SubjectCountPeriod, opt => opt.MapFrom(s => s.SubjectCountPeriod))
         //  .ForMember(d => d.CourseNameId, opt => opt.MapFrom(s => s.CourseNameId))
         //  .ForMember(d => d.CourseWeekId, opt => opt.MapFrom(s => s.CourseWeekId))
         //  .ForMember(d => d.MarkTypeId, opt => opt.MapFrom(s => s.MarkTypeId))
         //  //.ForMember(d => d.TraineeId, opt => opt.MapFrom(s => s.TraineeId))
         //  .ForMember(d => d.CourseSectionId, opt => opt.MapFrom(s => s.CourseSectionId))
         //  .ForMember(d => d.CourseDurationId, opt => opt.MapFrom(s => s.CourseDurationId))
         //  .ForMember(d => d.BranchId, opt => opt.MapFrom(s => s.BranchId))
         //  //.ForMember(d => d.BnaSubjectNameId, opt => opt.MapFrom(s => s.BnaSubjectNameId))
         //  .ForMember(d => d.AttendanceComplete, opt => opt.MapFrom(s => s.AttendanceComplete))
         //  //.ForMember(d => d.ExamMarkComplete, opt => opt.MapFrom(s => s.ExamMarkComplete))
         //  .ForMember(d => d.ClassLocation, opt => opt.MapFrom(s => s.ClassLocation))
         //  .ForMember(d => d.TimeDuration, opt => opt.MapFrom(s => s.TimeDuration))
         // // .ForMember(d => d.ClassRoomName, opt => opt.MapFrom(s => s.ClassRoomName))
         ////  .ForMember(d => d.ClassTopic, opt => opt.MapFrom(s => s.ClassTopic))
         //  .ForMember(d => d.Remarks, opt => opt.MapFrom(s => s.Remarks))
         //  .ForMember(d => d.Date, opt => opt.MapFrom(s => s.Date));
         //   // .ForMember(d => d.ClassTypeId, opt => opt.MapFrom(s => s.ClassTypeId));
         //   //.ForMember(d => d.SubjectMarkId, opt => opt.MapFrom(s => s.SubjectMarkId));


         //   CreateMap<PerodListForm, ClassRoutine>().ReverseMap()
         //       .ForMember(d => d.subjectId, opt => opt.MapFrom(s => s.BnaSubjectNameId))
         //        .ForMember(d => d.traineeId, opt => opt.MapFrom(s => s.TraineeId))
         //        .ForMember(d => d.subjectMarkId, opt => opt.MapFrom(s => s.SubjectMarkId))
         //        .ForMember(d => d.classTypeId, opt => opt.MapFrom(s => s.ClassTypeId))
         //        .ForMember(d => d.classRoomName, opt => opt.MapFrom(s => s.ClassRoomName))
         ...
         //   CreateMap<ClassRoutineListDto, IEnumerable<ClassRoutine>>()
